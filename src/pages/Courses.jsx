...
import { getCourses, getLoggedUser, getPrograms } from "../data/api";
...
export default function Courses(){
  ...
  useEffect(() => {
    async function getData() {
      ...
      const tmpProgram = (await getPrograms()).filter((p)=>p.programcode === programCode)[0]
  ...
  function action(e) {
    ...
    setView(e.currentTarget.id.split("-")[0]);
  }
