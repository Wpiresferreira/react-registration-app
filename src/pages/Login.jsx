...
export default function Login() {
  ...
  return (
    <div className="flex justify-center w-[100vw]">
      <div className="w-[70vw] max-w-[600px] rounded-2xl items-center m-6 flex flex-col justify-around bg-gray-80 shadow-balanced">
        <div>Login</div>
        <div className="h-10 w-[300px] bg-white rounded-2xl mb-2">
          <input
            value={username}
            onChange={(e) => setUsername(e.target.value)}
            className="absolute w-[280px] ml-[18px] h-10 p-2 mt-7 bg-[transparent] shadow-balanced "
            type="text"
          ></input>
